            ...
            <section className="p-5" style={{ backgroundColor: "white" }}>
                <Row className="px-5">
                    <Col lg={8} className="py-3 booking-section">
                        <Container>
                            <div className="block">
                                <img src="/img/Pricing/1person.png" style={{ width: "400px", height: "283px", marginBottom: "8px" }} />
                            </div>
                            <Card
                                ...
                                cover={
                                    <div>
                                        <p style={{ fontSize: 25, fontWeight: 600, color: "#F4C2C2" }}>
                                        A Dedicated room in a 2 or 3 Bedroom Flat.
                                        </p>
                                        <p style={{ margin: 0, color: "#F4C2C2", marginTop: "3" }}> Preferred by Managers living alone in Bangalore, away from their family.</p>
                                    </div>
                                }
                            >
                                <div class="config space-min mt-3">
                                    <div class="flex" style={{ margin: 0, color: "#F4C2C2" }}>
                                        <div class="strong opacity-50 inline" style={{ fontSize: 25 }}>Balcony</div>
                                    ...
                                    <div class="flex" style={{ margin: 0, color: "#F4C2C2" }}>
                                        <div class="strong opacity-50 inline" style={{ fontSize: 25 }}>Bathroom</div>
                                    ...
                                    <div class="flex" style={{ margin: 0, color: "#F4C2C2" }}>
                                        <div class="strong opacity-50 inline" style={{ fontSize: 25 }}>Duration</div>
                                    ...
                                    <div class="flex" style={{ margin: 0, color: "#F4C2C2" }}>
                                        <div class="strong opacity-50 inline" style={{ fontSize: 25 }}>@</div>
                                        <select class="minimal inline js_attribute js_balcony" data-name="balcony">
                                ...
                                <div style={{ textAlign: "center", marginTop: "2px" }}>
                                    <div style={{ fontSize: 32, fontWeight: "900", color: "#F4C2C2" }}>
                                        ₹17,800*
                                    </div>
                            ...
                            <Card
                                ...
                                cover={
                                    <div>
                                        ...
                                        <p style={{ margin: 0, color: "#F4C2C2", marginTop: "3" }}> Preferred by corporate professionals living alone in Bangalore.</p>
                                    </div>
                                }
                            >
                                <div class="config space-min mt-3">
                    ...
                    <Col lg={8} className="py-3 booking-section">
                        <Container>
                            <div className="block">
                                <img src="/img/Pricing/3person.png" style={{ width: "400px", height: "283px", marginBottom: "8px" }} />
                            </div>
                            <Card
                                className="module-border-wrap px-5 py-10"
                                id="scale-up-1"
                                ...
                                cover={
                                    <div>
                                        ...
                                        <p style={{ margin: 0, color: "#F4C2C2", marginTop: "3" }}>Preferred by Students, Interns and Trainees living alone in Bangalore.</p>
                                    </div>
                                }
                            >
                                <div class="config space-min mt-3">
